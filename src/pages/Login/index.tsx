  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <div className="flex-[0.2] md:flex-1 flex items-center bg-primary">
        <h1 className="text-3xl md:text-5xl font-bold text-white leading-[3rem] md:leading-[4.2rem] p-[3rem] md:p-[5rem]">
          Lets Begin Your
          <br />
          Journey with
          <br />
      ...
      <div className="flex-1 flex items-center justify-center p-[3rem] md:p-[5rem] flex-col">
        <div className="w-full flex flex-col">
          ...
          <TextInput
            onChange={async (e) => await formik.setFieldValue('email', e.target.value)}
            onBlur={() => null}
            id="email"
            name="email"
        ...
        <div className="w-full flex flex-col mt-5">
          ...
          <TextInput
            type="password"
            onChange={async (e) => await formik.setFieldValue('password', e.target.value)}
            onBlur={() => null}
            id="password"
            name="password"
            value={formik.values.email}
